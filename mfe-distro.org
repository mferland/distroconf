...
sudo VBoxManage extpack install --replace Oracle_VM_VirtualBox_Extension_Pack-6.1.0_RC1.vbox-extpack
sudo usermod -aG vboxusers marc
rm Oracle_VM_VirtualBox_Extension_Pack-6.1.0_RC1.vbox-extpack
reboot
