...
wget https://download.virtualbox.org/virtualbox/5.2.38/Oracle_VM_VirtualBox_Extension_Pack-5.2.38.vbox-extpack
sudo VBoxManage extpack install --replace Oracle_VM_VirtualBox_Extension_Pack-5.2.38.vbox-extpack
sudo usermod -aG vboxusers marc
rm Oracle_VM_VirtualBox_Extension_Pack-5.2.38.vbox-extpack
reboot
